...
int frameNumber = 1;  // Start counting frames from 1
...
void uploadPhotoToFirebase() {
    ...
    if (!base64Image.isEmpty()) {
        // Create a frame number for the current image
        String frameNumberStr = String(frameNumber);

        // Create the Firebase path using the frame number
        String path = "/photos/frame_" + frameNumberStr;
        ...
        // Increment the frame number for the next image
        frameNumber++;
    } else {
